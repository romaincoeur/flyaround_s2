    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/terrain')) {
            ...
            if (rtrim($pathinfo, '/') === '/terrain') {
                ...
                return array (  '_controller' => 'Flyaround\\MapBundle\\Controller\\TerrainController::indexAction',  '_route' => 'terrain',);
            }

            // terrain_show
            if (preg_match('#^/terrain/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'terrain_show')), array (  '_controller' => 'Flyaround\\MapBundle\\Controller\\TerrainController::showAction',));
            }

            // terrain_new
            if ($pathinfo === '/terrain/new') {
                return array (  '_controller' => 'Flyaround\\MapBundle\\Controller\\TerrainController::newAction',  '_route' => 'terrain_new',);
            }

            // terrain_create
            if ($pathinfo === '/terrain/create') {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_terrain_create;
                }

                return array (  '_controller' => 'Flyaround\\MapBundle\\Controller\\TerrainController::createAction',  '_route' => 'terrain_create',);
            }
            not_terrain_create:

            // terrain_edit
            if (preg_match('#^/terrain/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'terrain_edit')), array (  '_controller' => 'Flyaround\\MapBundle\\Controller\\TerrainController::editAction',));
            }

            // terrain_update
            if (preg_match('#^/terrain/(?P<id>[^/]++)/update$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('POST', 'PUT'))) {
                    $allow = array_merge($allow, array('POST', 'PUT'));
                    goto not_terrain_update;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'terrain_update')), array (  '_controller' => 'Flyaround\\MapBundle\\Controller\\TerrainController::updateAction',));
            }
            not_terrain_update:

            // terrain_delete
            if (preg_match('#^/terrain/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('POST', 'DELETE'))) {
                    $allow = array_merge($allow, array('POST', 'DELETE'));
                    goto not_terrain_delete;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'terrain_delete')), array (  '_controller' => 'Flyaround\\MapBundle\\Controller\\TerrainController::deleteAction',));
            }
            not_terrain_delete:

        }

        if (0 === strpos($pathinfo, '/fly')) {
            // fly
            if (rtrim($pathinfo, '/') === '/fly') {
                if (substr($pathinfo, -1) !== '/') {
                    return $this->redirect($pathinfo.'/', 'fly');
                }

                return array (  '_controller' => 'Flyaround\\MapBundle\\Controller\\FlyController::indexAction',  '_route' => 'fly',);
            }

            // fly_show
            if (preg_match('#^/fly/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'fly_show')), array (  '_controller' => 'Flyaround\\MapBundle\\Controller\\FlyController::showAction',));
            }

            // fly_new
            if ($pathinfo === '/fly/new') {
                return array (  '_controller' => 'Flyaround\\MapBundle\\Controller\\FlyController::newAction',  '_route' => 'fly_new',);
            }

            // fly_create
            if ($pathinfo === '/fly/create') {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_fly_create;
                }

                return array (  '_controller' => 'Flyaround\\MapBundle\\Controller\\FlyController::createAction',  '_route' => 'fly_create',);
            }
            not_fly_create:

            // fly_edit
            if (preg_match('#^/fly/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'fly_edit')), array (  '_controller' => 'Flyaround\\MapBundle\\Controller\\FlyController::editAction',));
            }

            // fly_update
            if (preg_match('#^/fly/(?P<id>[^/]++)/update$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('POST', 'PUT'))) {
                    $allow = array_merge($allow, array('POST', 'PUT'));
                    goto not_fly_update;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'fly_update')), array (  '_controller' => 'Flyaround\\MapBundle\\Controller\\FlyController::updateAction',));
            }
            not_fly_update:

            // fly_delete
            if (preg_match('#^/fly/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('POST', 'DELETE'))) {
                    $allow = array_merge($allow, array('POST', 'DELETE'));
                    goto not_fly_delete;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'fly_delete')), array (  '_controller' => 'Flyaround\\MapBundle\\Controller\\FlyController::deleteAction',));
            }
            not_fly_delete:

        }

        // flyaround_map_homepage
        if ($pathinfo === '/app') {
            return array (  '_controller' => 'Flyaround\\MapBundle\\Controller\\DefaultController::indexAction',  '_route' => 'flyaround_map_homepage',);
        }
        ...
        if (rtrim($pathinfo, '/') === '') {
            ...
            return array (  '_controller' => 'Flyaround\\CoreBundle\\Controller\\DefaultController::indexAction',  '_route' => 'homepage',);
        }
